...
<!DOCTYPE html>
<html lang="en">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/join/join2.css">
...
<head>
    ...
    <script type="text/javascript" src="../javascript/vaildcheck.js"></script>
	<script type="text/javascript" src="../javascript/sweetalert2.min.js"></script>
                                ...
                                <table class="join_table">
                                    ...
                                    <tr class="join_table_tr" id="tr_join_id">
                                        ...
                                        <td class="join_col_2_td stbb">
                                            <div class="join_item">
                                                <span class="inputbox"><input name="uid" type="text" maxlength="30" id="join_id"
                                                    class="join_form_control dlb wid200" placeholder="공백,특수문자 없이 4~12자"
                                                    style="ime-mode: disabled"></span>
                                                <div class="join_id_info_check">
                                        ...
                                        <td class="join_col_2_td  stbb">
                                            <div class="join_item">
                                                <input name="upw" type="password" maxlength="20" id="join_pw"
                                                    ...
                                                    placeholder="대소문자와 숫자 8~20자리">
                                                <div class="div_info_maroon sstc">
                                                    <span id="join_pw_info" class="sstc helptext"></span>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td class="join_col_2_td  stbb">
                                            <div class="join_item">
                                                ...
                                                <div class="div_info_maroon sstc" style="clear: both; ">
                                                    <span id="join__email_info" class="sstc helptext"></span>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
