  ...
  <jsp:include page="/header/header.jsp"/>
    <main>
      ...
      <section class="container">
        ...
        <form  method="post" action="${pageContext.request.contextPath}/lostpet/controller/LostPetUpdateOk.lo" 
        ...
        name="findWriteForm" enctype="multipart/form-data">
          ...
          //시간 입력
            ...
            <div class="find-q">
              ...
              <select class="form-control inputarea" name="lpspecies" value="${lostpet.getLpspecies()}">
                  동물 종을 선택하세요.
                </option>
            ...
            <div class="find-q">
              ...
              <select class="form-control inputarea" name="lpgender" value="${lostpet.getLpgender()}">
                <option value="none" selected style="color: #555">
                  성별 (중성화 여부)를 선택하세요
                </option>
              ...
              <select class="form-control inputarea" name="lpage" value="${lostpet.getLpage()}">
                <option value="none" selected style="color: #555">
                  나이를 선택하세요.
                </option>
...
<div style="clear:both;"></div>
            ...
            <div class="find-q">
              ...
              <textarea name="lpcontent" class="width-place form-control inputarea"  style="width:60%; height:264px; resize: none;" value="${lostpet.getLpcontent()}"></textarea>
